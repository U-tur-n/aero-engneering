...
\begin{align}
\label{eq:風洞揚力係数}
C_{L_0} = \frac{L_0}{\frac{1}{2}\rho_0' {U_0'}^2 S_0} = \frac{L_0}{\frac{1}{2} \cdot 11.89 \cdot 268.7^2 \cdot 122.4} = 1.903 \times 10^-8 L_0
\end{align}
同様に，風洞試験時の抗力係数$C_{D_0}$は以下のようになる．
\begin{align}
\label{eq:風洞抗力係数}
C_{D_0} = \frac{D_0}{\frac{1}{2}\rho_0' U_0'^2 S_0} = \frac{D_0}{\frac{1}{2} \cdot 11.89 \cdot 268.7^2 \cdot 122.4} = 1.903 \times 10^-8 D_0
\end{align}
...
\begin{split}
\label{eq:風洞揚力}
L_0 &= \frac{C_{L_0} \cdot \frac{1}{2} \cdot \rho_0' \cdot {U_0'}^2 \cdot S_0}{1.903 \times 10^-8} \\
&= \frac{0.04765 \cdot \frac{1}{2} \cdot 11.89 \cdot 268.7^2 \cdot 122.4}{1.903 \times 10^-8} \\
\end{split}
\end{align}

\section{数値流体力学を用いた模型の風洞試験を用いた揚力$L$，抗力$D$の求め方}
ナヴィエ・ストークス方程式は非線形の偏微分方程式であるため，解析的に解くことは困難である．そのため，数値流体力学(CFD)を用いて数値的に解く必要がある．具体的には，
